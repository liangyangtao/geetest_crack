...
function(a, b) {
    ...
    j = function(a, b, c) {
        b in h ? "loaded" === h[b].status ? c && c(h[b].content) : "loading" === h[b].status ? k.P(b + "Loaded",
        function() {
            c && c(h[b].content)
        }) : w("module " + b + " lost!") : (h[b] = {
            status: "loading"
    ...
    k.q = function(a, b) {
        ...
        c && (c.callback.call(Q.f("self", b)), c.once && (k.V(a, c, b), e -= 1))
    },
    k.R = function(a) {
        var b, c = k.z.global[a];
        if (c) for (var d = 0; d < c.length; d++) b = c[d],
        b && (b.callback(), b.once && (k.V(a, b), d -= 1))
    };
    var l = function(a, b) {
        var c = b || {};
    ...
    G = function(a, b, c) {
        ...
        var d = "geetest_" + o();
        window[d] = function(a) {
            a.error && (w(a.error), k.q("error", c.id), k.q("statusChange", c.id), q(window, d)),
            b.call(c, !1, a, c)
        },
        E(a + "&callback=" + d,
        function(b) {
    ...
    var P = function(a, b, c) {
        ...
        function(a, d, e, g) {
            ...
            function() {
                if (z.loaded_theme[c.config.theme]) c.config.mobile && !z.mobileSkins[c.config.theme] ? k.P(c.config.theme + "Loaded",
                function() {
                    Q.p("loaded", !0, c.id),
                    k.q("loaded", c.id)
    ...
    S.ia = function(a) {
        var b = a.$,
        c = b(".gt_logo_button");
        a.config.logo ? (c.href = z.homepage, c.target = "_blank") : S.na(c, "no_logo"),
    ...
    c.prototype.appendTo = function(a, b) {
        return Q.f("loaded", this.id) ? S.ea.call(this, a, b) : k.P("loaded",
        function() {
            S.ea.call(this, a, b)
        },
        this.id),
    ...
    U = function() {
        ...
        c = function(a, b) {
            ...
            var e = a.$;
            T.ma(e(".gt_fullbg"), c),
            "slide" == a.config.type ? (T.ma(e(".gt_bg"), 0, c), T.ma(e(".gt_slice"), 0, c)) : (T.ma(e(".gt_curtain"), d), T.ma(e(".gt_curtain_button"), d))
        },
        d = function(b, c, d, e, f) {
            ...
            var i, j, k, l = [];
            if (Q.f(b + "Arr", f.id)) for (l = Q.f(b + "Arr", f.id), i = 0, j = l.length; i < j; i++) l[i].style.backgroundImage = "url(" + c + ")";
            else {
                Q.p(b + "Arr", l, f.id);
                var m, n = a(),
    ...
    aa.f = function(a, b) {
        for (var c, d = 0,
        e = aa.z.length; d < e; d++) if (c = aa.z[d], c.dom == a && c.event == b) return c;
        return c = {
            dom: a,
            event: b,
            handlerList: [],
    ...
    aa.u = function(a, b, c) {
        for (var d, e = aa.evts[b], f = aa.f(a, b), g = 0, h = e.length; g < h; g++) f.handlerList.length && (d = f.ta, window.addEventListener ? a.removeEventListener(e[g], d, !1) : window.attachEvent && a.detachEvent("on" + e[g], d)),
        window.addEventListener ? (f.handlerList.push(c), f.ta = function(b) {
            for (var c = 0,
    ...
    ba.ta = function(a, b) {
        ...
        e = d(".gt_slice"),
        f = d(".gt_slider_knob");
        if (b && b.type) return oa.ma("fail", c, 3e3),
        pa.ma("lock", c),
        ...
        500);
        if (a || "error" === b.message) oa.ma("error", c),
        pa.ma("error", c),
        ...
        k.q("error", c.id);
            ...
            400)
        } else "fail" == b.message ? (oa.ma("fail", c), pa.ma("fail", c), T.o(e, 100), T.ma(e, 100, 100), T.o(e, 100, 200), T.ma(e, 100, 300), T.l(e, 400, 500, !1,
        function() {
            ba.l(0, c, !0)
    ...
    da = function(a) {
        ...
        d = Q.f("status", a.id), e = "ready" == d || "success" == d || "error" == d, f = Q.f("in", a.id), g = a.$(".gt_widget"), h = Q.f("hideDelay", a.id) || [], j = 0, k = h.length; j < k; j++) clearTimeout(h[j]);
        h = [];
        var l;
        if (e && !f) {
    ...
    ga = function(a, b) {
        ...
        d != e && (b.config.sandbox && S.da(b.cloneDom, b.dom), Q.p("in", e, b.id), k.q("hoverChange", b.id))
    },
    ha = function(a) {
        var b = a.$;
        Q.p("in", !1, a.id),
    ...
    ia.h = function(a) {
        ...
        a.id);
        var c = a.$;
        aa.u(c(".gt_mask"), "click",
        function() {
            ia.o(a)
        }),
        aa.u(c(".gt_popup_cross"), "click",
        function() {
            ia.o(a)
        })
    },
    ia.za = function(a) {
        ...
        if (!Q.f("DOMReady", b.id)) return void k.P("DOMReady",
        function() {
            ia.za.call(b, a)
        },
        b.id);
    ...
    c.prototype.bindOn = function(a) {
        return Q.f("loaded", this.id) ? ia.za.call(this, a) : k.P("loaded",
        function() {
            ia.za.call(this, a)
        },
        this.id),
    ...
    na = function() {
        ...
        f = function(a) {
            for (var b, f = c(Q.f("arr", a)), g = [], h = [], i = [], j = 0, k = f.length; j < k; j++) b = e(f[j]),
    ...
    ra.onError = function(a) {
        ...
        a || (b.config.mobile ? k.q("SvgError", b.id) : (Q.p("status", "error", b.id), pa.ma("error", b), oa.ma("error", b, !1)), clearTimeout(Q.f("autoRefresh", b.id)))
    },
    ra.onReady = function() {
    ...
    c.prototype.onSuccess = function(a) {
        if ("function" == typeof a) return Q.p("onSuccess", a, this.id),
        this;
        throw new Error(e.callbackError)
    },
    c.prototype.onFail = function(a) {
        if ("function" == typeof a) return Q.p("onFail", a, this.id),
        this;
        throw new Error(e.callbackError)
    },
    c.prototype.onRefresh = function(a) {
        if ("function" == typeof a) return Q.p("onRefresh", a, this.id),
        this;
        throw new Error(e.callbackError)
    },
    c.prototype.onError = function(a) {
        if ("function" == typeof a) return Q.p("onError", a, this.id),
        this;
        throw new Error(e.callbackError)
    },
    c.prototype.onStatusChange = function(a) {
        if ("function" == typeof a) return Q.p("onStatusChange", a, this.id),
        this;
        throw new Error(e.callbackError)
    },
    c.prototype.onReady = function(a) {
        if ("function" == typeof a) return Q.p("onReady", a, this.id),
        this;
        throw new Error(e.callbackError)
    },
    ...
    c.prototype.hideRefresh = function() {
        var a = this;
        if (!Q.f("DOMReady", a.id)) return k.P("DOMReady",
        function() {
            a.hideRefresh()
        },
        a.id),
    ...
    c.prototype.zoom = function(a) {
        var b = this;
        if (!Q.f("DOMReady", b.id)) return k.P("DOMReady",
        function() {
            b.zoom(a)
        },
        b.id),
